<template>
  ...
  >
    ...
    <ellipse cx="91" cy="703.78" rx="41.4" ry="6.35" fill="#3490dc" opacity="0.1"></ellipse>
    <ellipse cx="688.12" cy="712.42" rx="41.4" ry="6.35" fill="#3490dc" opacity="0.1"></ellipse>
    <ellipse cx="586.13" cy="771.25" rx="41.4" ry="6.35" fill="#3490dc" opacity="0.1"></ellipse>
    <ellipse cx="225.15" cy="656.4" rx="41.4" ry="6.35" fill="#3490dc" opacity="0.1"></ellipse>
    <ellipse cx="237.47" cy="773.99" rx="237.47" ry="51.19" fill="#3490dc" opacity="0.1"></ellipse>
    <path
    ...
    <polygon
      ...
      fill="#d48a9b"
    ></polygon>
    <polygon points="479.37 441 413.48 441 413.48 417.09 479.37 421.73 479.37 441" fill="#d48a9b"></polygon>
    <polygon points="479.37 441 413.48 441 413.48 417.09 479.37 421.73 479.37 441" opacity="0.1"></polygon>
    <polygon
    ...
    <polygon
      ...
      fill="#fff"
    ></polygon>
    <polygon points="96.65 649.48 98.22 648.94 97.43 660.1 96.65 660.38 96.65 649.48" opacity="0.1"></polygon>
    <polygon
    ...
    <path
      ...
      fill="#d3dae1"
    ></path>
    <circle cx="50" cy="737.26" r="9.39" fill="#535461"></circle>
    <circle cx="66.8" cy="773.99" r="9.39" fill="#535461"></circle>
    <circle cx="234.33" cy="780.64" r="9.39" fill="#535461"></circle>
    <circle cx="271.76" cy="732.71" r="9.39" fill="#535461"></circle>
    <rect x="154.05" y="571.43" width="11.76" height="73.47" fill="#535461"></rect>
    <rect x="154.05" y="633" width="11.76" height="11.9" opacity="0.1"></rect>
    <rect x="151.78" y="635.8" width="16.3" height="81.52" fill="#3a3768"></rect>
    <path
    ...
    <path
      ...
      opacity="0.1"
    ></path>
    <ellipse cx="159.51" cy="563.98" rx="43.39" ry="12.69" fill="#3a3768"></ellipse>
    <path
    ...
    <polygon
      ...
      fill="#3490dc"
    ></polygon>
    <ellipse cx="413.42" cy="222.94" rx="1.8" ry="1.78" fill="#fff"></ellipse>
    <polygon
    ...
    <polygon
      ...
      fill="#d5e1f4"
    ></polygon>
    <ellipse cx="883.43" cy="794.36" rx="64.2" ry="9.85" fill="#3490dc" opacity="0.1"></ellipse>
    <path
    ...
    <path
      ...
      fill="#ffd037"
    ></path>
    <ellipse cx="900.66" cy="679.99" rx="74.6" ry="11.45" fill="#3490dc" opacity="0.1"></ellipse>
    <path
